...
//void QUA_helicopter::EnterVehicle( CBasePlayer *pPlayer )
void QUA_helicopter::EnterVehicle(CBaseCombatCharacter *pPassenger)
{
...
Vector QUA_helicopter::CalcDamageForceVector( const CTakeDamageInfo &info )
{
	...
	if ( info.GetDamageForce() != vec3_origin || (info.GetDamageType() & DMG_PREVENT_PHYSICS_FORCE) )
	{
