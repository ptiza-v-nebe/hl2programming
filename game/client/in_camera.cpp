...
ConVar cam_idealdist( "cam_idealdist", "300", FCVAR_ARCHIVE | FCVAR_CHEAT );	 // thirdperson distance
...
static ConVar c_maxdistance( "c_maxdistance",   "400", FCVAR_ARCHIVE| FCVAR_CHEAT );
